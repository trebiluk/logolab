...
- Warmup uses the Solvay school day (America/New_York).
- New floor station: Optical QC.
- Press `?` for keys. Enter replays a finished studio.
- Factory ranks and punch-card brag board. XP is brag, not a 3/2/1.

## LL 1.0.0 — 2026-09-18

- Six stations, shop-floor games, joke cousins, paper copies, XP on this device.
